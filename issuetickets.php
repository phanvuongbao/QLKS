            ...
            <div class="container">
                ...
                <form name="chngpwd" method="post" onSubmit="return valid();">
                    <?php if ($error) { ?>
                        ...
                        <div class="succWrap"><strong>Đã hoàn thành</strong><?php echo htmlentities($msg); ?>
                        </div><?php } ?>
                    <p>
                    <table border="1" width="100%">
                        <tr align="center">
                            ...
                            <th style="white-space: nowrap">Admin Remark</th>
                            <th style="white-space: nowrap">Reg Date</th>
                            <th style="white-space: nowrap">Remark date</th>
